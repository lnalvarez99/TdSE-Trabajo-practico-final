...
#define BTN_INGRESO_PRESSED  GPIO_PIN_SET
#define BTN_INGRESO_REALESED GPIO_PIN_RESET

#define BTN_EGRESO_PORT     BTN_EGRESO_GPIO_Port
#define BTN_EGRESO_PIN      BTN_EGRESO_Pin
#define BTN_EGRESO_PRESSED  GPIO_PIN_SET
#define BTN_EGRESO_REALESED GPIO_PIN_RESET

#define BTN_MODE_PORT       BTN_MODE_GPIO_Port
#define BTN_MODE_PIN        BTN_MODE_Pin
#define BTN_MODE_PRESSED    GPIO_PIN_SET
#define BTN_MODE_REALESED   GPIO_PIN_RESET

#define BTN_ENTER_PORT     BTN_ENTER_GPIO_Port
#define BTN_ENTER_PIN      BTN_ENTER_Pin
#define BTN_ENTER_PRESSED  GPIO_PIN_SET
#define BTN_ENTER_REALESED GPIO_PIN_RESET
...
#define SW_BARRERA_ON        GPIO_PIN_SET
#define SW_BARRERA_OFF       GPIO_PIN_RESET

#define SW_DESACTIVAR_PORT   SW_DESACTIVAR_GPIO_Port
#define SW_DESACTIVAR_PIN    SW_DESACTIVAR_Pin
#define SW_DESACTIVAR_ON     GPIO_PIN_SET
#define SW_DESACTIVAR_OFF    GPIO_PIN_RESET
...
#define LED_MOTOR_MAX_ON     GPIO_PIN_SET
#define LED_MOTOR_MAX_OFF    GPIO_PIN_RESET

#define LED_MOTOR_MIN_PORT   LED_MOTOR_MIN_GPIO_Port
#define LED_MOTOR_MIN_PIN    LED_MOTOR_MIN_Pin
#define LED_MOTOR_MIN_ON     GPIO_PIN_SET
#define LED_MOTOR_MIN_OFF    GPIO_PIN_RESET

#define LED_SYSTEM_PORT      LED_SYSTEM_GPIO_Port
#define LED_SYSTEM_PIN       LED_SYSTEM_Pin
#define LED_SYSTEM_ON        GPIO_PIN_SET
#define LED_SYSTEM_OFF       GPIO_PIN_RESET

#define LED_ALERT_PORT       LED_ALERT_GPIO_Port
#define LED_ALERT_PIN        LED_ALERT_Pin
#define LED_ALERT_ON         GPIO_PIN_SET
#define LED_ALERT_OFF        GPIO_PIN_RESET
